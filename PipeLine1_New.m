...
kNN_ULDA_mRMR_model=fitcknn(ULDA_mRMR_Train,TrainLabels,'NumNeighbors',k,'Distance',DistMeas);   %Creates a quadratic model
kNN_ULDA_SFS_model=fitcknn(ULDA_SFS_Train,TrainLabels,'NumNeighbors',k,'Distance',DistMeas);   %Creates a quadratic model
kNN_PCA_mRMR_Model=fitcknn(PCA_mRMR_Train,TrainLabels,'NumNeighbors',k,'Distance',DistMeas);   %Creates a quadratic model
kNN_PCA_SFS_Model=fitcknn(PCA_SFS_Train,TrainLabels,'NumNeighbors',k,'Distance',DistMeas);   %Creates a quadratic model
...
DT_ULDA_mRMR_model=fitctree(ULDA_mRMR_Train,TrainLabels,'MinLeafSize',MinLeaf);   %Creates a quadratic model
DT_ULDA_SFS_model=fitctree(ULDA_SFS_Train,TrainLabels,'MinLeafSize',MinLeaf);   %Creates a quadratic model
DT_PCA_mRMR_Model=fitctree(PCA_mRMR_Train,TrainLabels,'MinLeafSize',MinLeaf);   %Creates a quadratic model
DT_PCA_SFS_Model=fitctree(PCA_SFS_Train,TrainLabels,'MinLeafSize',MinLeaf);   %Creates a quadratic model
...
%save('Classifiers.mat','NB_Model','LDA_Model','QDA_Model','kNN_Model','DT_Model','SVM_Model', 'ULDA_W');
