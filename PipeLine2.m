...
ROCScores = SVMImageClassifications(classifiedIdx);
[ROCX{threshLoopCounter}, ROCY{threshLoopCounter}] = perfcurve(labels(classifiedIdx), ROCScores, 2);
...
lgd = legend('0.05', '0.1', '0.15', '0.2', '0.25', '0.3', '0.35', '0.4', ... 
    '0.5', '0.6', '0.7', 'Location', 'southeast');
title(lgd, 'Threshold Values')
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for Classification of SVM')

% Confusion matrix
figure
C = confusionmat(labels, SVMImageClassifications);
confusionchart(C)
title('Confusion Matrix for SVM Classifier with Threshold of 0.7')
